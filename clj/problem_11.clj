...
(def GRID
  (to-array-2d [[8, 2, 22, 97, 38, 15, 0, 40, 0, 75, 4, 5, 7, 78, 52, 12, 50, 77, 91, 8],
...
(def best-point (apply (partial max-key (partial apply best)) points))

(println best-point)
(println (apply best best-point))
